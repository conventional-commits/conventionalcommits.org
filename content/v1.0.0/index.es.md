...
5. Una descripción DEBE ir inmediatamente después de los dos puntos y el espacio del prefijo de tipo/ámbito. La descripción es resumen corto de los cambios realizados en el código, ej., _fix: array parsing issue when multiple spaces were contained in string._.
...
15. Las unidades de información que componen Commits Convencionales NO DEBEN ser sensibles a mayúsculas por quienes realizan implementaciones, con la excepción de BREAKING CHANGE que DEBE ir en mayúsculas.
